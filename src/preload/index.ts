...
const api: YouTraceApi = {
  ...
  planning: {
    ...
    listDailyFocus: (date) => ipcRenderer.invoke('planning:list-daily-focus', date),
    setDailyFocus: (input) => ipcRenderer.invoke('planning:set-daily-focus', input),
    ...
    removeTaskDependency: (taskId, prerequisiteTaskId) => ipcRenderer.invoke('planning:remove-task-dependency', taskId, prerequisiteTaskId),
  ...
  practice: {
    ...
    clearHabitRecord: (habitId, date) => ipcRenderer.invoke('practice:clear-habit-record', habitId, date),
    ...
    listMetricEntries: (metricId) => ipcRenderer.invoke('practice:list-metric-entries', metricId),
    updateMetricEntry: (input) => ipcRenderer.invoke('practice:update-metric-entry', input),
    deleteMetricEntry: (id) => ipcRenderer.invoke('practice:delete-metric-entry', id),
