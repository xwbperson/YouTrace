...
- [有迹 v1.0.7 安装版](https://github.com/xwbperson/YouTrace/releases/download/v1.0.7/YouTrace-1.0.7-Setup.exe)
- [有迹 v1.0.7 便携版](https://github.com/xwbperson/YouTrace/releases/download/v1.0.7/YouTrace-1.0.7-Portable.exe)

安装包目前没有 Authenticode 数字签名，Windows SmartScreen 可能显示“未知发布者”。

| 文件 | SHA-256 |
|---|---|
| `YouTrace-1.0.7-Setup.exe` | `63FEE615CE7CF12343A0B8CC84D41080BCD31BAD4B6DC03CEB21908F3A97996B` |
| `YouTrace-1.0.7-Portable.exe` | `E1610FA1B2827D71CAD0D25C05D98AA63B02F3FF74AB5A7A45216893340CF113` |
...
代码、76 项单元/集成测试、文档链接、生产构建和本机 Windows 发布包构建已经验证。本轮未执行
Electron 界面自动测试，后续由用户手动验收。整体版本仍保持
